...
-export([start_http/0, docroot/0, get_map/2, send_map/3, get_Product/0, get_name/3, put_map/2, get_konva_thing/2, edit_konva/2]).
...
%% dgiot_map:send_map(<<"9b5c1a3ed5">>, <<"001">>, #{<<"Acrel">> => 10,<<"current">> => 20,<<"current">> => 30}).
send_map(ProductId, Devaddr, Payload) ->
    DeviceId = shuwa_parse:get_deviceid(ProductId, Devaddr),
    Shape =
